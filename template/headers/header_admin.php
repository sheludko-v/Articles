...
<head>
  ...
  <title>Stigmat ONLINE | Личный кабинет</title>
</head>
  ...
  <div class="row no-gutter">
    <div class="col-12">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark navbar_top" style="background-color: #1F100D;">
        ...
        <a class="navbar-brand" href="/"><span class="logoAd">STIGMAT ONLINE | ЛИЧНЫЙ КАБИНЕТ</span></a>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="/admin/create">Создать статью</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/logout" onclick="return confirm('Вы уверены, что хотите выйти?')">Выйти</a>
            </li>
